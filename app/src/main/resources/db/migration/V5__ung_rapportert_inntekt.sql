...
CREATE INDEX idx_ung_rapportert_inntekt_soker_ident ON ung_rapportert_inntekt (søker_ident);
...
CREATE INDEX idx_ung_rapportert_inntekt_inntekt ON ung_rapportert_inntekt USING gin (inntekt);
