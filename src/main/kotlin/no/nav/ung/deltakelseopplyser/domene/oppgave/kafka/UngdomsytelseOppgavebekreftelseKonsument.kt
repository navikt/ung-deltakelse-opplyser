...
import no.nav.ung.deltakelseopplyser.domene.oppgave.kafka.UngdomsytelseOppgavebekreftelseKonsumentConfiguration.Companion.UNGDOMSYTELSESOPPGAVEBEKREFTELSE_FILTER
...
class UngdomsytelseOppgavebekreftelseKonsument(
    ...
    @KafkaListener(
        ...
        filter = UNGDOMSYTELSESOPPGAVEBEKREFTELSE_FILTER,
        properties = [
    ...
    fun konsumer(
        ...
        val oppgavebekreftelseTopicEntry =
            objectMapper.readValue(
                ungdomsytelseOppgavebekreftelseTopicEntry,
                UngdomsytelseOppgavebekreftelseTopicEntry::class.java
            )
...
class UngdomsytelseOppgavebekreftelseKonsumentConfiguration(
    ...
    companion object {
        ...
        internal const val UNGDOMSYTELSESOPPGAVEBEKREFTELSE_FILTER = "ungdomsytelsesOppgavebekreftelseFilter"
    }
    ...
    fun ungdomsytelseOppgavebekreftelseFilter() = RecordFilterStrategy<String, String> { consumerRecord ->
        try {
            val oppgavebekreftelseTopicEntry =
                objectMapper.readValue(consumerRecord.value(), UngdomsytelseOppgavebekreftelseTopicEntry::class.java)
